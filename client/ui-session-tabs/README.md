...
- Uninstall: `dsh plugin --profile web remove @wowayou/ui-session-tabs`, then reload the tab.
...
卸载：`dsh plugin --profile web remove @wowayou/ui-session-tabs`，然后刷新页面。
